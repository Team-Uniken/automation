- Milestone 7-APRIL  ( On track, Ract wireframe on ios are added with module, there are some chalanges with call back handlings , things are work in progress)
	- [x] integration of wire frames for IOS with module
	- [x] Demo Init API @ ios 
	- [x] Integrate wire frame for Android (build splash screen only)
...
- Milestone 15-APRIL
	...
	- [ ] QUESTION - Can we open source the banking application?
	- [ ] Commit to REL-ID_internal/REL-IDmobile with .gitignore for libraries
