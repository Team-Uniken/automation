...
-(void)getNotificationHistory:(CDVInvokedUrlCommand*)command{
  ...
  callbackID = command.callbackId;
  @try{
    int errorCode = [rdnaObject getNotificationHistory:[[command.arguments objectAtIndex:0] intValue] withEnterpriseID:[command.arguments objectAtIndex:1] withStartIndex:[[command.arguments objectAtIndex:2]intValue] withStartDate:[command.arguments objectAtIndex:3] withEndDate:[command.arguments objectAtIndex:4] withNotificationStatus:[command.arguments objectAtIndex:5] withActionPerformed:[command.arguments objectAtIndex:6] withKeywordSearch:[command.arguments objectAtIndex:7] withDeviceID:[command.arguments objectAtIndex:8]];
