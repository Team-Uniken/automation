...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(showNetworkAlert:)
                                               name:@"showNetworkAlert" object:nil];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
  ...
  // If your application supports background execution, this method is called instead of applicationWillTerminate: when the user quits.
   ...
   [self.rdnaclient EnterBackground];
}


- (void)applicationWillEnterForeground:(UIApplication *)application {
  // Called as part of the transition from the background to the active state; here you can undo many of the changes made on entering the background.
  [self.rdnaclient EnterForeground];
}
...
- (void)applicationWillTerminate:(UIApplication *)application {
  ...
  [self.rdnaclient terminateRDNAWithCallbackDelegate:nil];
  [self saveContext];
}
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"com_uniken_poc_pocwallet"];
...
- (void)showNetworkAlert:(NSNotification *)note {
