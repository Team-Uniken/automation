  ...
  render() {
    return (
      <View style={Skin.appointmentrow.customerow}>
					 <TouchableHighlight  activeOpacity={1.0} underlayColor={Skin.colors.REPPLE_COLOR}
					 ...
					 <View style={Skin.appointmentrow.col}>
						<View style={Skin.appointmentrow.row }>
							<Text style={Skin.appointmentrow.date}>{this.props.date}</Text>
            ...
            <Text style={Skin.appointmentrow.div1}> </Text>
					</View>
					 </TouchableHighlight>
      </View>
    );
...
var Appointment = React.createClass({
  ...
  renderRow(rowData) {
    return <SampleRow {...rowData} style={Skin.appointmentrow.row} />
  },
  render() {
    return (
