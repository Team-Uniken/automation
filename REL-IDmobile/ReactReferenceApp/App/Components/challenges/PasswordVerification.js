...
let chlngJson;
let nextChlngName;
const {Text, ScrollView, TextInput, View, Platform, Animated, DeviceEventEmitter, TouchableHighlight, InteractionManager, AsyncStorage, TouchableOpacity, Alert, } = ReactNative;
...
class PasswordVerification extends Component {
  ...
  updateProgress() {
    setTimeout((function() {
      this.setState({
        progress: this.state.progress + (0.4 * Skin.loadspd)
      });
