...
*/
let responseJson;
const {View, Text, TextInput, TouchableHighlight, TouchableOpacity, } = ReactNative;
      ...
      <MainActivation navigator={ this.props.navigator }>
        ...
        <View style={ Skin.activationStyle.input_wrap }>
          <View style={ Skin.activationStyle.textinput_wrap }>
            ...
            <TextInput returnKeyType={ 'next' } autoCorrect={ false } secureTextEntry keyboardType={ 'default' } placeholderTextColor={ Skin.PLACEHOLDER_TEXT_COLOR_RGB }
              style={ Skin.activationStyle.textinput } value={ this.state.inputUsername } ref={ 'accessCode' } placeholder={ 'Code' } onChange={ this.onAccessCodeChange.bind(this) } onSubmitEditing={ this.checkAccessCode.bind(this) }
            />
          </View>
        </View>
        ...
        <View style={ Skin.activationStyle.input_wrap }>
          <TouchableOpacity style={ Skin.activationStyle.button } underlayColor={ Skin.login.BUTTON_UNDERLAY } onPress={ this.checkAccessCode.bind(this) } activeOpacity={ 0.6 }>
