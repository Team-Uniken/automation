...
export default class NotificationCard extends Component {
  ...
  getNotificationButton(notification, body) {
    var uiElementArray = [];

    for (let i = 0; i < notification.actions.length; i++) {
      var myBtnStyle;
      if (i == 0) {
        myBtnStyle = style.approvebutton;
      } else if (i == 1) {
        myBtnStyle = style.rejectbutton;
      } else if (i == 2) {
        myBtnStyle = style.fraudbutton;
      } else {
        myBtnStyle = style.approvebutton;
      }
      uiElementArray.push([
    ...
    return [<View style={style.notificationButton}>{uiElementArray}</View>];
  }
          ...
          >
            ...
            >
              <View style={[style.col, { flex: 1 }]}>
                ...
                {this.props.showButtons &&
                  this.props.notification.actions.length == 1 && (
                    <View style={[style.row, { marginTop: 8 }]}>
                      <View style={style.notificationButton}>
                        <TouchableHighlight
                          style={style.approvebutton}
                ...
                {this.props.showButtons &&
                  this.props.notification.actions.length > 3 && (
                    <View style={[style.row, { marginTop: 8 }]}>
