...
extern NSString* ASAppSecurityThreatSpeciesDescription(ASSecurityThreatSpecies species);
extern NSString* ASNetSecurityThreatSpeciesDescription(ASSecurityThreatSpecies species);
extern NSString* ASSysSecurityThreatSpeciesDescription(ASSecurityThreatSpecies species);
...
typedef void (^ASMonitorObserverCallback_t)(NSArray<ASSecurityThreat *> * newThreats, NSArray<ASSecurityThreat *> *resolvedThreats, NSArray<ASSecurityThreat *> *allActiveThreats);

- (void) addObserverWithCallback:(ASMonitorObserverCallback_t)callback;

- (NSArray<ASSecurityThreat *> *) activeThreats;
