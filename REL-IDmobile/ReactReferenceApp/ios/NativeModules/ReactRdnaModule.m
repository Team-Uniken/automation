...
//  NSError *jsonError;
//  NSData *jsonObject = [status dataUsingEncoding:NSUTF8StringEncoding];
//  NSDictionary *json = [NSJSONSerialization JSONObjectWithData:jsonObject
