...
public class RCTCameraModule extends ReactContextBaseJavaModule
    ...
    public static final String RCT_CAMERA_CAMERA_MODE_ON = "on";
    public static final String RCT_CAMERA_CAMERA_MODE_OFF = "off";
    public static final String RCT_CAMERA_CAMERA_MODE_AUTO = "auto";
    ...
    private void captureWithOrientation(final ReadableMap options, final Promise promise, int deviceOrientation) {
        ...
        Log.e("Camera","captureWithOrientation");
        ...
        Log.e("Camera","captureWithOrientation1");
        ...
        camera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                Log.e("Camera","captureWithOrientation2");
                camera.stopPreview();
                camera.startPreview();
                Log.e("Camera","captureWithOrientation3");
                WritableMap response = new WritableNativeMap();
                switch (options.getInt("target")) {
                    case RCT_CAMERA_CAPTURE_TARGET_MEMORY:
    ...
    public void hasFlash(ReadableMap options, final Promise promise) {
        ...
        Log.e("Camera","hasFlash");
        List<String> flashModes = camera.getParameters().getSupportedFlashModes();
        Log.e("Camera","hasFlash1");
