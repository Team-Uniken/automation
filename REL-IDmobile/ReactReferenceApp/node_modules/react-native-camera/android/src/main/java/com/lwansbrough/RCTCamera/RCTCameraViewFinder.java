...
class RCTCameraViewFinder extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    Handler uiHandler;
    static long instanceIdCounter = 0;
    ...
    public RCTCameraViewFinder(Context context, int type) {
        ...
        if (uiHandler == null) {
            uiHandler = new android.os.Handler(getContext().getMainLooper());
        }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        int retryCount = 1;
        while(false == startCamera() && retryCount>0){
            retryCount--;
        }
    }
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        ...
        Log.e("Camera","onSurfaceTextureDestroyed");
        stopCamera();
        return true;
    }
    ...
    synchronized protected boolean startCamera() {
        boolean isStarted = false;
            try {
                if (_camera == null) {
                    isStarted = RCTCamera.getInstance().startCamera(_cameraType, _captureMode, _surfaceTexture, this);
                    _camera = RCTCamera.getInstance().getCamera(_cameraType);
                }
            } catch (Exception e) {
                isStarted = false;
               // e.printStackTrace();
    ...
    synchronized protected void stopCamera() {
        try{
            //this.setSurfaceTextureListener(null);
            RCTCamera.getInstance().stopCamera(_cameraType);
            _camera = null;
        }
    ...
    private class ReaderAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... ignored) {
            ...
            try {
                if (RCTCamera.getInstance().getCamera(_cameraType) != null) {
                    Log.e("Camera","ReaderAsyncTask");
                    Camera.Size size = camera.getParameters().getPreviewSize();
                    Log.e("Camera","ReaderAsyncTask1");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        // Get the pointer ID
        try {
            Log.e("Camera","onTouchEvent");
            Camera.Parameters params = _camera.getParameters();
            Log.e("Camera","onTouchEvent1");
            ...
            if (event.getPointerCount() > 1) {
                ...
                if (action == MotionEvent.ACTION_POINTER_DOWN) {
                    ...
                    Log.e("Camera","onTouchEvent2");
                    _camera.cancelAutoFocus();
                    handleZoom(event, params);
                    Log.e("Camera","onTouchEvent3");
                }
            } else {
    ...
    private void handleZoom(MotionEvent event, Camera.Parameters params) {
        ...
        params.setZoom(zoom);
        Log.e("Camera","handleZoom");
        _camera.setParameters(params);
        Log.e("Camera","handleZoom1");
    }
