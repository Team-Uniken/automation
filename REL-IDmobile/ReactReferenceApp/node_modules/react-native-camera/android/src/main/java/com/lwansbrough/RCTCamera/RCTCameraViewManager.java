...
public class RCTCameraViewManager extends ViewGroupManager<RCTCameraView> {
    ...
    public static final int COMMAND_SET_CAMERA_MODE = 1;


    @Override
    public Map<String,Integer> getCommandsMap() {
        Log.d("React", " View manager getCommandsMap:");
        return MapBuilder.of("setCameraMode", COMMAND_SET_CAMERA_MODE);
    }
    ...
    public void setCameraMode(RCTCameraView view,ReadableArray args){
        String cameraMode = args.getString(0);
        if(cameraMode == null)
            return;

        if(cameraMode.equals(RCTCameraModule.RCT_CAMERA_CAMERA_MODE_ON)){
            view.setCameraMode(true);
            view.startCamera();
        }

        if(cameraMode.equals(RCTCameraModule.RCT_CAMERA_CAMERA_MODE_OFF)){
            view.setCameraMode(false);
            view.stopCamera();
        }
    }
}
